...
Evalúa una condición. Si esta es verdadera, ejecuta el bloque de código interno. Si es falsa, continúa con la siguiente instrucción fuera de la estructura.
